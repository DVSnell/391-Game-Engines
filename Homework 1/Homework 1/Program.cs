...
namespace Homework_2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ageSum = ageMachine + Player.ageUser;
            ...
            //        //Question Generation from Class
            //        FistAddend.Addends();
            ...
            //        //Answer Generation and Storage from Class
            //        Answers.Sums();
            ...
            for (int x = 0; x < 10; x++)
            {
                Console.WriteLine(Scoreboard.name[x] + " got a score of " + Scoreboard.score[x]);
            }
            Console.WriteLine();
            System.Threading.Thread.Sleep(3000);
